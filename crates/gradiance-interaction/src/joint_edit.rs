...
pub fn glyph_distance(
    ...
    match &def.kind {
        ...
        // A rigid link is drawn, and so picked, as the segment between its
        // two anchors — the same shape as a spring, without the coil.
        JointKind::Spring { .. } | JointKind::Fixed => match world_b {
