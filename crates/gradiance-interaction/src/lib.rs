...
impl Plugin for InteractionPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.init_resource::<gradiance_domain::settings::GridSettings>();
        app.init_resource::<gradiance_domain::settings::SnapConfig>();
        app.init_resource::<gradiance_domain::settings::DebugSettings>();
        app.init_resource::<gradiance_domain::settings::ToolDefaults>();
        ...
        app.register_type::<gradiance_domain::settings::GridSettings>();
