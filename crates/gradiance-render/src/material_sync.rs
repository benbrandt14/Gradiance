...
pub fn sync_body_materials(
    ...
    changed: Query<
        (
            ...
            &gradiance_domain::shape::ShapeDef,
        ),
        (
            With<Body>,
        ...
        .chain(removed.iter().filter_map(|e| bodies.get(*e).ok()))
    {
        ...
        if matches!(shape, gradiance_domain::shape::ShapeDef::HalfPlane) {
            continue;
        }
