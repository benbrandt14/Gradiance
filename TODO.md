...
## High Priority
- [x] **Move Tool Implementation**: Implement `MoveTool` logic to select rigidbodies under the cursor and move them using `TargetJoint2D` or Transform manipulation.
...
- [x] **Undo/Redo System**: Command pattern implementation for actions.
- [ ] **UI Polish**: Replace runtime-generated UI with a proper Prefab-based UI or UI Toolkit for better layout and styling.
- [x] **Camera Controls**: Add pan and zoom functionality to the Main Camera.
