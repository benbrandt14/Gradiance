...
// TODO: Refactor: Split this massive struct into smaller, focused widgets/systems. See TECH_DEBT.md.
// Consider using a custom `SystemParam` struct or separate systems for Physics, Transform, Visuals.
#[derive(SystemParam)]
